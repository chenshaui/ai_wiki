...
- Github (119k stars): https://github.com/microsoft/generative-ai-for-beginners

Microsoft 开源了一份 21 节课的完整课程 —— 从生成式 AI 基础概念，到 RAG、AI Agent、模型微调、图像生成、向量数据库，覆盖生成式 AI 应用开发的全链路。

119k Star， 50+ 语言翻译，每一节课都有视频 + 代码 + 阅读材料。这是一套真正的开发者课程。

# 21. AI Engineering from Scratch

- 项目地址 （52k stars）：https://github.com/rohitg00/ai-engineering-from-scratch
- 在线课程：https://aiengineeringfromscratch.com
- 中文翻译 （1k stars）：https://github.com/fancyboi999/ai-engineering-from-scratch-zh 

AI Engineering from Scratch：503 节课，20 个阶段，从线性代数到自主多 Agent 系统

这个课程最难得的是完整性——它把 AI 工程的每一个环节都覆盖了：
...
- 概率统计：贝叶斯推断、最大似然估计
核心算法
- 手写 Tokenizer（BPE、WordPiece）
- 实现 Self-Attention（不用 PyTorch）
- 从零构建 Transformer
- 实现 RLHF 训练循环
Agent 系统
- Tool Calling 协议实现
- 持久化记忆系统（Agent Memory）
- 多 Agent 协作框架
...
Easy-Vibe 不是又一个编程教程。它是把「AI 时代人人都会编程」这句话，真正做成了可执行的学习路径。10K Star，Datawhale 出品，适合转给身边想学但不知道怎么开始的零基础朋友。

GitHub：https://github.com/datawhalechina/easy-vibe

在线阅读：https://datawhalechina.github.io/easy-vibe/welcome.html
