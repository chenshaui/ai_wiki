...
### 1.0.1 ai-engineering-from-scratch

- 项目仓库：https://github.com/rohitg00/ai-engineering-from-scratch
- 课程网站：https://aiengineeringfromscratch.com

20 个阶段大致可归为四段：

- 基础打底（Phase 0–3）：开发环境与工具、数学基础、机器学习基础、深度学习核心。
- 模型核心（Phase 4–10）：视觉 / NLP / 语音等专门领域、Transformer 深入、生成式 AI、强化学习，直到从零手写一个大模型（这一段单独就有 34 节课）。
- 工程与生产（Phase 11–18）：工程化、生产部署、伦理与安全、多 Agent 系统。
- 实战收尾（Phase 19）：毕业项目——85 节课，覆盖 17 个端到端产品。
